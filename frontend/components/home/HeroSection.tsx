...
//             MAIN HERO
//         ========================================================== */}
//         <div className="grid min-h-[680px] items-center gap-10 py-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-8 lg:py-16">
//           {/* =======================================================
//               LEFT CONTENT
//           ======================================================== */}
...
//             {/* Heading */}
//             <h1 className="max-w-[680px] text-[44px] font-extrabold leading-[1.05] tracking-[-0.04em] text-[#1B2A4A] sm:text-[54px] lg:text-[64px]">
//               Quality Healthcare,
...
//             ====================================================== */}
//             <div className="absolute right-0 top-0 h-[500px] w-full max-w-[590px] overflow-hidden rounded-[38px] bg-[#eaf7f8] shadow-[0_25px_70px_rgba(27,42,74,0.14)] sm:h-[540px] lg:h-[570px]">
//               <Image
...
//             ====================================================== */}
//             <div className="absolute bottom-0 left-[-8px] z-40 h-[190px] w-[275px] overflow-hidden rounded-[28px] border-[6px] border-white bg-white shadow-[0_25px_55px_rgba(27,42,74,0.20)] sm:left-[-20px] sm:h-[225px] sm:w-[330px]">
//               <Image
...
//             ====================================================== */}
//             <div className="absolute bottom-8 right-[-5px] z-30 flex size-[105px] items-center justify-center rounded-full border-[8px] border-white bg-[#fff5ec] shadow-[0_15px_35px_rgba(245,130,31,0.15)] sm:size-[125px]">
...
//             TRUST FEATURE STRIP
//         ========================================================== */}
//         <div className="relative border-t border-[#e4eeee] py-7">
...
//       <div
//         aria-hidden="true"
//         className="pointer-events-none absolute bottom-0 left-0 h-16 w-full overflow-hidden"
//       >
//         <div className="absolute -bottom-20 left-[-5%] h-32 w-[55%] rounded-[50%] bg-[#e5f7f8]" />

//         <div className="absolute -bottom-24 right-[-5%] h-40 w-[55%] rounded-[50%] bg-[#eef9fa]" />
//       </div>
//     </section>
//   );
// }
